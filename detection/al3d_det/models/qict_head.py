...
class qictMM(nn.Module):
    def __init__(self, model_cfg, num_class, dataset):
        super().__init__()
        self.lidar = qictMM_LiDAR(
            model_cfg=model_cfg, num_class=num_class, dataset=dataset)
        self.camera = qictMM_Camera(model_cfg)
